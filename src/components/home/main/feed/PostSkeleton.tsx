      ...
      <div className="animate-pulse">
        <div className="flex justify-between items-center">
          <div className="flex space-x-2 justify-center items-center gap-2 ">
            ...
            <div className="text-gray-500 dark:text-gray-300 hover:underline cursor-pointer font-semibold text-lg">
              <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4"></div>
            </div>
            <div className="text-gray-500 dark:text-gray-400 font-semibold text-base md:flex hidden ">
